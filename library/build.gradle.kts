...
<body>
    ...
    <div class="module">
        <h2><a href="agui4k-core/index.html">agui4k-core</a></h2>
        <p class="description">Core types, events, and protocol definitions for the AG-UI protocol</p>
    </div>
    
    <div class="module">
        <h2><a href="agui4k-client/index.html">agui4k-client</a></h2>
        <p class="description">Client implementations, HTTP transport, SSE parsing, and state management</p>
    </div>
    
    <div class="module">
        <h2><a href="agui4k-agent-sdk/index.html">agui4k-agent-sdk</a></h2>
        <p class="description">High-level stateful and stateless agent SDKs with conversation management</p>
    </div>
    
    <div class="module">
        <h2><a href="agui4k-tools/index.html">agui4k-tools</a></h2>
