// agui4k-agent-sdk/src/commonTest/kotlin/com/contextable/agui4k/sdk/integration/AgentToolIntegrationTest.kt
package com.contextable.agui4k.sdk.integration

import com.contextable.agui4k.client.agent.HttpAgent
// HttpAgentConfig no longer exists - removed import
...
class AgentToolIntegrationTest {
    ...
    fun testAgentWithSingleTool() = runTest {
        ...
        val agent = AgUi4KAgent("https://test-api.com") {
    ...
    fun testStatefulAgentWithTools() = runTest {
        ...
        val statefulAgent = com.contextable.agui4k.sdk.StatefulAgUi4KAgent("https://test-api.com") {
            this.toolRegistry = toolRegistry
            systemPrompt = "You are a helpful assistant. Remember our conversation context."
